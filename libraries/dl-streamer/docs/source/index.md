...
**Deep Learning Streamer** is an open-source
...
- Customize and extend your solution by reviewing, analyzing, and
  modifying Deep Learning Streamer open-sourced code

![Deep Learning Streamer SW Stack](_images/overview_sw_stack.png)

**Deep Learning Streamer** uses OpenVINO™ Runtime inference back-end
...
**Deep Learning Streamer** provides over two dozen samples, demos and
...
**Deep Learning Streamer** offers a long list of models and samples
